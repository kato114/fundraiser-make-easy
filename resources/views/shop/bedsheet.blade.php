            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li class="active"><a href="{{ route('bedsheet') }}">Bedsheet</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="tab-content">
                            @for($i = 1; $i < 15; $i++)
                            <div id="thumb{{ $i }}" class="tab-pane {{ $i != 1 ? '' : 'active' }}">
                    ...
                    <div class="col-lg-6">
                        <div class="row mx-0 mb-4">
                            ...
                            <div class="team-progress">
                                ...
                                <h6 class="mt-2"><strong>$37.50</strong><strong class="pull-right">$250</strong></h6>
                                <div class="progress mt-2">
                                    <div class="progress-bar progress-bar-success progress-bar-striped progress-bar-animated bg-success" role="progressbar"
                        ...
                        <div class="kiosk-product-description fix">
                            ...
                            <div class="pro-ref mtb-15">
                                ...
                                <div class="kiosk-product-thumb">
                                    ...
                                    @for($i = 1; $i < 15; $i++)
                                        <a class="{{ $i != 1 ? '' : 'active' }}" data-toggle="tab" href="#thumb{{$i}}"> <img class="mb-1" src="{{ asset('assets/front/img/color/'.$i.'.jpg') }}" alt="kiosk-product-thumb" width="20"></a>
                                    @endfor   
                                    </div>
                                </div>
                            </div>
